...
class SvmGdfResults(object):
    ...
    feature_columns_dict = {
        ...
        'pca_gdf_que_pca1': all_gdf_que,
        'pca_gdf_que_pca2': all_gdf_que,
    }
    ...
    def get_number_of_pca_components(feature_name: str) -> Optional[int]:
        ...
        if 'pca_gdf_que_pca' in feature_name:
            return int(feature_name.replace('pca_gdf_que_pca', ''))
...
def main(stock, r=0.1, s=0.1):
    try:
        results_dir = 'res_pca2_gdf_que_15000'
        data_length = 15000
        result_csv = os.path.join(results_dir, 'svm_sigmoid_pca2_gdf_que_{}_len{}_r{}_s{}.csv'.format(
