...
def train_gru(res):
    ...
    filename = os.path.join(res_dir, f'pred_gru_iter_{stock}_len{data_length}_r{r}_s{s}.csv')
...
def main():
    ...
    res = [pool.apply_async(train_gru, [df_best[df_best['stock'] == int(s)]]) for s in stocks]
