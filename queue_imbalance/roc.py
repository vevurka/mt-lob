...
stocks = [
    '11399', '2645', '9069', '9063', '9926', '1472', '9094', '9270', '10166', '9061',
    '2822', '2651', '2051', '1865', '1243', '4060', '1221', '2368', '12456', '12327', '2094',
    '9064', '9034', '2748', '9761', '1956', '12098', '11244', '1113', '10795', '13061',
    '10887', '11234', '9062', '1769', '7858', '4154', '4218', '13003', '9067', '10508', '2057',
    '12534', '1907', '4481', '4549', '4618', '3035', '11867', '4851', '2730', '12713', '3757',
    '10470',
    '9265', '4799', '11618', '1388', '9086', '9058', '11583', '2050', '2197', '9268', '12552',
    '9065',
    '2602', '3161', '9074', '4736', '3459', '13113', '2290', '9269', '12059', '3879', '1229',
    '4695',
    '5836', '10484', '2890', '1694', '1080', '3107', '11038', '12417', '9266', '4320', '3022',
    '3388', '8080',
    '1431', '12255', '7843', '11714', '4575', '2028', '11946', '2813', '11869'
]
...
for s in stocks:
    try:
        ...
        reg_svm = lob.svm_classification(d, 0, len(d))

        print('performing predictions', s)
        pred_svm_in_sample = reg_svm.predict(d['queue_imbalance'].values.reshape(-1, 1))
        pred_svm_out_of_sample = reg_svm.predict(d_test['queue_imbalance'].values.reshape(-1, 1))
        pred_in_sample = reg.predict(d['queue_imbalance'].values.reshape(-1, 1))
        pred_out_of_sample = reg.predict(
            d_test['queue_imbalance'].values.reshape(-1, 1))
        logit_roc_auc = roc_auc_score(d_test['mid_price_indicator'], pred_out_of_sample)
        fpr, tpr, thresholds = roc_curve(d_test['mid_price_indicator'].values,
                                         reg.predict_proba(
                                             d_test['queue_imbalance'].reshape(-1, 1))[:, 1])
        plt.plot(fpr, tpr, label='{} (area = {})'.format(s, logit_roc_auc))
        rocs_areas[s] = logit_roc_auc
        plt.plot([0, 1], [0, 1], 'r--')
        plt.xlim([0.0, 1.0])
        plt.ylim([0.0, 1.05])
...
r = {'11399': 0.59151574578931998, '2645': 0.55035670049721375, '9069': 0.54862448368600902,
     ...
     '13061': 0.55542753242712406, '10887': 0.54743083003952575, '11234': 0.60048892168004919,
