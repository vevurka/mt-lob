...
stocks = [
    ...
    '4481', '4549']
stocks = ['4618', '3035', '11867', '4851', ]
stocks = ['2730', '12713', '3757', '10470', '9265',
...
coef0s = [0, 0.0001, 0.001, 1, 10, 100, 1000]
...
def main():
    for s in stocks:
        ...
        for c in cs:
            for g in gammas:
                for coef0 in coef0s:
                    svm = SVMSigmoid(s, df, c=c, coef0=coef0, gamma=g, data_length=None)
                    svm.fit()
